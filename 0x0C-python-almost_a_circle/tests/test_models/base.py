...
class Test_Base(unittest.TestCase):
    """Defines a class for testing base.py file."""

    def test_instance_type_id_class(self):
        """Tests for initialization of class"""
        b1 = Base()
    ...
    def test_id_value(self):
        """Tests when id has a integer value"""
        b1 = Base(12)
    ...
    def test_object_attributtes(self):
        """Tests for attributes dictionary of a object"""
        b1 = Base()
    ...
    def tearDown(self):
        """Test method to reset class attributes"""
